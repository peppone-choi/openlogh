...
class NationCommandTest {
    ...
    fun `초토화 golden value -- city resources reduced to exact values`() {
        ...
        val generalRepository = mock(com.openlogh.repository.GeneralRepository::class.java)
        ...
        val mockServices = CommandServices(
            ...
            nationRepository = mock(com.openlogh.repository.NationRepository::class.java),
    ...
    fun `초토화 golden value -- fails on capital city`() {
        ...
        val mockServices = CommandServices(
            generalRepository = mock(com.openlogh.repository.GeneralRepository::class.java),
            cityRepository = mock(com.openlogh.repository.CityRepository::class.java),
            nationRepository = mock(com.openlogh.repository.NationRepository::class.java),
            diplomacyService = mock(com.openlogh.engine.DiplomacyService::class.java),
        )
    ...
    private fun createMockServicesBundle(): MockServicesBundle {
        val generalRepository = mock(com.openlogh.repository.GeneralRepository::class.java)
        val cityRepository = mock(com.openlogh.repository.CityRepository::class.java)
        val nationRepository = mock(com.openlogh.repository.NationRepository::class.java)
    ...
    private data class MockServicesBundle(
        ...
        val generalRepository: com.openlogh.repository.GeneralRepository,
