...
class TurnServiceTest {
    ...
    fun setUp() {
        ...
        service = TurnService(
            ...
            mock(com.openlogh.service.NationService::class.java),
    ...
    fun `processWorld fires fireCommand consumed after consuming a nation turn`() {
        ...
        val nation = com.openlogh.entity.Nation(id = 1, worldId = 1, name = "위", color = "#FF0000")
        ...
        val serviceWithEvent = TurnService(
            ...
            nationService = mock(com.openlogh.service.NationService::class.java),
