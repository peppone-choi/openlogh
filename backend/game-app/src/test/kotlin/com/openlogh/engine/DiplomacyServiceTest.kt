...
class DiplomacyServiceTest {
    ...
    fun `declareWar creates 선전포고 and kills pending proposals`() {
        seed(
            createDiplomacy(id = 1, srcFactionId = 1, destFactionId = 2, stateCode = "불가침제의", term = 5),
            createDiplomacy(id = 2, srcFactionId = 1, destFactionId = 2, stateCode = "종전제의", term = 5),
        )
    ...
    fun `killAllRelationsForNation kills active only`() {
        seed(
            createDiplomacy(id = 1, srcFactionId = 5, destFactionId = 2, stateCode = "불가침", term = 10),
            createDiplomacy(id = 2, srcFactionId = 3, destFactionId = 5, stateCode = "선전포고", term = 10),
            createDiplomacy(id = 3, srcFactionId = 5, destFactionId = 4, stateCode = "불가침", term = 10, isDead = true),
        )
    ...
    fun `getRelations returns world relations and createRelation persists`() {
        seed(
            createDiplomacy(id = 1, srcFactionId = 1, destFactionId = 2, stateCode = "불가침", term = 10),
            createDiplomacy(id = 2, srcFactionId = 2, destFactionId = 3, stateCode = "선전포고", term = 10),
        )
