...
-- Source: gin7 manual p50 — "地上戦に参加できるユニットの種類は、惑星のタイプによって
-- 異なります(惑星タイプは現在未実装となっております)".
--
-- Values:
--   'normal'   : default, all three ground unit types allowed
--   'gas'      : gas giant, no heavy 裝甲兵 (armored infantry)
--   'fortress' : fortress assault, no heavy 裝甲兵
--
