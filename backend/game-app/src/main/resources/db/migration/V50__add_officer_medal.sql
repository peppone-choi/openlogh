-- V50: Add medal_rank and medal_count to officer for 서훈 system (Phase 24-09)
-- Source: gin7 manual p34-35 — 계급 사다리 제3법칙 (서훈한최고 훈장 순위)
...
--
-- RankLadderService consumes medal_rank as the 제3법칙 tie-breaker in its
...
COMMENT ON COLUMN officer.medal_rank IS 'Highest medal rank (0=none). gin7 p34 rank ladder 제3법칙.';
