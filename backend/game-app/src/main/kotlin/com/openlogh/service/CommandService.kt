...
class CommandService(
    ...
    private fun buildFullGeneralTurnQueue(general: com.openlogh.entity.General, existing: List<GeneralTurn>, maxTurn: Int): MutableList<GeneralTurn> {
    ...
    private fun replaceGeneralTurns(general: com.openlogh.entity.General, turns: List<GeneralTurn>): List<GeneralTurn> {
    ...
    private fun defaultGeneralTurn(general: com.openlogh.entity.General, turnIdx: Short): GeneralTurn {
        return GeneralTurn(
            worldId = general.worldId,
    ...
    private fun buildFullNationTurnQueue(general: com.openlogh.entity.General, existing: List<NationTurn>, maxChiefTurn: Int): MutableList<NationTurn> {
        val indexed = existing.associateBy { it.turnIdx.toInt() }
    ...
    private fun replaceNationTurns(general: com.openlogh.entity.General, turns: List<NationTurn>): List<NationTurn> {
    ...
    private fun defaultNationTurn(general: com.openlogh.entity.General, turnIdx: Short): NationTurn {
        return NationTurn(
            worldId = general.worldId,
