...
class BattleEngine {
    ...
    data class BattleResultWithPhases(
        ...
        val phaseDetails: List<com.openlogh.dto.BattlePhaseDetail>,
    )
    ...
    fun resolveBattleWithPhases(
        ...
        val phaseDetails = mutableListOf<com.openlogh.dto.BattlePhaseDetail>()
        val logs = mutableListOf<String>()
        var totalAttackerDamage = 0
        var totalDefenderDamage = 0
        var attackerDamageDealtForExp = 0
        ...
        while (currentPhase < maxPhase) {
            ...
            phaseDetails.add(com.openlogh.dto.BattlePhaseDetail(
                phase = currentPhase,
