...
class GeneralService(
    ...
    private fun resolvePicture(user: com.opensam.entity.AppUser, useOwnIcon: Boolean): Pair<String, Short> {
    ...
    private fun applyJoinInheritCost(user: com.opensam.entity.AppUser, pointsToSpend: Int) {
