...
- [ ] **SHIP-01**: 11함종 × I~VIII 서브타입 함정 유닛 구현 (ship_stats JSON 기반, 300척 단위)
- [ ] **SHIP-02**: 진영별 함종 차이 구현 (제국: 고속전함/뇌격정모함, 동맹: 타격순항함)
- [ ] **SHIP-03**: 기함 유닛 구현 (고유명 기함 + 범용기함, 계급별 결정)
...
- [ ] **ECON-01**: 행성 자원 시스템 (인구/생산/교역/치안/지지도/궤도방어/요새방어)
- [ ] **ECON-02**: 조병창 자동생산 (행성별 자동생산 품목, 지배권 이전까지 계속)
- [ ] **ECON-03**: 세율/납입률 시스템 (행성별 세수→진영 자금, 90일 주기 징수)
- [ ] **ECON-04**: 행성/부대 창고 시스템 (행성창고↔부대창고 간 이동)
