...
- ✓ 세션 참가/진영 선택 + 3:2 비율 제한 — Validated in Phase 1: Session Foundation
- ✓ 오프라인 CP 회복 (온/오프라인 무관) — Validated in Phase 1: Session Foundation
- ✓ Officer @Version 낙관적 락 (CP 레이스 컨디션 해소) — Validated in Phase 1: Session Foundation
- ✓ 전술전 executor 쓰레드 릭 수정 — Validated in Phase 1: Session Foundation

### Active

**세션 시스템**

- [x] 세션 생성/참가/진영 선택 (최대 2,000명) — Validated in Phase 1
- [ ] 게임 시간 (실시간 24배속)
- [ ] 승리/패배 조건 판정 및 세션 종료
...
_Last updated: 2026-03-28 after Phase 1 (Session Foundation) completion_
