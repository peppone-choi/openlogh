...
**Plans**: 18 plans
Plans:
- [x] 14-01-PLAN.md — Backend DTO extension — CommandHierarchy + TacticalUnit fields
- [x] 14-02-PLAN.md — Backend — BattleSummaryDto + /summary REST endpoint
- [x] 14-03-PLAN.md — Backend — sensorRange field + computation + DTO wiring
...
- [x] 14-11-PLAN.md — Frontend — Fog-of-war reducer + FogLayer rendering
- [x] 14-12-PLAN.md — Frontend — Sub-fleet drag-gating helper (FE-02)
- [x] 14-13-PLAN.md — Frontend — Sub-fleet assignment drawer component (FE-02)
...
- [x] 23-04-PLAN.md — Gin7 salary outlay + FactionAI bill integration
...
| 23. gin7 economy full port | v2.3 | 8/10 | In Progress|  |
