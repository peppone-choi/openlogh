...
Plans:
- [ ] 07-01-PLAN.md — S10 장교 데이터 완성 + LOGH 시나리오 초기 함대 생성
- [ ] 07-02-PLAN.md — 커스텀 캐릭터 8-stat 유효성 강화 + 시나리오 참가 페이지
- [ ] 07-03-PLAN.md — 밸런스 검증 테스트 (전투/CP비용/경제 3종)
- [ ] 07-04-PLAN.md — 전체 플로우 통합 테스트 (시나리오 초기화→커맨드→경제→커스텀 캐릭터)
...
| 7. 시나리오 데이터 + 밸런싱 | 0/4 | Not started | - |
