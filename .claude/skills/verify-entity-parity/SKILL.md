...
| File                                                            | Purpose                                |
| --------------------------------------------------------------- | -------------------------------------- |
| `backend/game-app/src/main/kotlin/com/opensam/entity/General.kt`         | 장수 엔티티 (5-stat, crew/train/atmos) |
| `backend/game-app/src/main/kotlin/com/opensam/entity/City.kt`            | 도시 엔티티                            |
| `backend/game-app/src/main/kotlin/com/opensam/entity/Nation.kt`          | 국가 엔티티                            |
| `backend/game-app/src/main/kotlin/com/opensam/entity/WorldState.kt`      | 월드 상태 엔티티                       |
| `backend/game-app/src/main/kotlin/com/opensam/entity/AppUser.kt`         | 유저 엔티티                            |
| `backend/game-app/src/main/kotlin/com/opensam/entity/Troop.kt`           | 부대 엔티티                            |
| `backend/game-app/src/main/kotlin/com/opensam/entity/Diplomacy.kt`       | 외교 엔티티                            |
| `backend/game-app/src/main/kotlin/com/opensam/entity/Message.kt`         | 메시지 엔티티                          |
| `backend/game-app/src/main/kotlin/com/opensam/entity/Event.kt`           | 게임 이벤트 엔티티                     |
| `backend/game-app/src/main/kotlin/com/opensam/entity/GeneralTurn.kt`     | 장수 턴 엔티티                         |
| `backend/game-app/src/main/kotlin/com/opensam/entity/NationTurn.kt`      | 국가 턴 엔티티                         |
| `backend/game-app/src/main/kotlin/com/opensam/entity/NationFlag.kt`      | 국가 플래그 엔티티                     |
| `backend/game-app/src/main/resources/db/migration/V1__core_tables.sql`   | 초기 DB 스키마 (핵심 테이블)           |
| `backend/game-app/src/main/resources/db/migration/V2__add_user_role.sql` | 유저 역할 추가                         |
...
**파일:** `backend/game-app/src/main/kotlin/com/opensam/entity/General.kt`

**검사:** General 엔티티에 정확히 5개의 스탯 필드가 존재하는지 확인합니다.

```bash
grep -n "var leadership\|var strength\|var intel\|var politics\|var charm" backend/game-app/src/main/kotlin/com/opensam/entity/General.kt
```
...
```bash
grep -rn "intelligence\|charisma\b" backend/game-app/src/main/kotlin/com/opensam/entity/ frontend/src/types/
```
...
```bash
grep -rn "soldiers\|unitType\|training\b\|morale\b" backend/game-app/src/main/kotlin/com/opensam/entity/ frontend/src/types/
```
...
```bash
grep -n "var crew\b\|var crewType\|var train\b\|var atmos\b" backend/game-app/src/main/kotlin/com/opensam/entity/General.kt
```
...
for f in Nation City General Troop Diplomacy Message Event GeneralTurn NationTurn NationFlag; do
  if grep -q 'var world\b\|var worldState\b' "backend/game-app/src/main/kotlin/com/opensam/entity/${f}.kt"; then
...
grep -rn "@Table" backend/game-app/src/main/kotlin/com/opensam/entity/ 2>/dev/null

# migration 파일의 CREATE TABLE 목록
grep -rn "CREATE TABLE" backend/game-app/src/main/resources/db/migration/ 2>/dev/null
```
...
```bash
grep -n "leadership\|strength\|intel\b\|politics\|charm" backend/game-app/src/main/resources/db/migration/V1__core_tables.sql
```
