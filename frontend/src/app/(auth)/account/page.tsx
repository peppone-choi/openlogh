                ...
                <CardContent className="space-y-6 p-0">
                    ...
                    <div className="space-y-2 rounded-md border p-3">
                        ...
                        <div className="text-sm space-y-1">
                            <p>
                                <span className="text-muted-foreground">계정 ID:</span> {user?.loginId ?? '-'}
                            </p>
                            <p>
                                <span className="text-muted-foreground">표시 이름:</span> {user?.displayName ?? '-'}
                            </p>
                            {detailedInfo && (
                                <>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        {detailedInfo.joinDate
                                            ? new Date(String(detailedInfo.joinDate)).toLocaleDateString('ko-KR')
                                            : '-'}
                                    </p>
                                    <p>
                    ...
                    {thirdUseStatus && (
                        <div className="space-y-2 rounded-md border border-yellow-500/30 p-3">
                            <h2 className="text-sm font-semibold text-muted-foreground">제3자 제공 동의 철회</h2>
                            <p className="text-xs text-muted-foreground">개인정보 제3자 제공 동의를 철회합니다.</p>
                            <Button
                                size="sm"
                                variant="outline"
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="space-y-2 flex-1">
                                ...
                                <div className="space-y-1">
                                    <label htmlFor="icon-upload-input" className="text-xs text-muted-foreground">
                                        파일 업로드
                                    </label>
                    ...
                    <div className="space-y-2 rounded-md border p-3">
                        ...
                        <p className="text-xs text-muted-foreground">휴가 모드 토글은 즉시 적용됩니다.</p>
                    ...
                    <div className="space-y-3">
                        ...
                        {pwMsg && (
                            <p className={`text-sm ${pwMsg.includes('변경되었') ? 'text-green-400' : 'text-red-400'}`}>
                                {pwMsg}
                            </p>
                        )}
                    ...
                    <div className="relative w-full max-w-sm mx-4 rounded-lg border bg-background p-6 shadow-xl">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <Button variant="outline" className="flex-1" onClick={() => setShowIconSync(false)}>
                                    취소
                                </Button>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="delete-confirm-input" className="text-xs text-muted-foreground">
                                    확인을 위해 <span className="font-bold text-red-400">탈퇴합니다</span>를 입력하세요
                                </label>
                                <Input
                            ...
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    disabled={deleting || !deletePassword || deleteConfirmText !== '탈퇴합니다'}
                                >
                                    {deleting ? (
                                        <>
                                            <Loader2 className="size-3 animate-spin mr-1" />
