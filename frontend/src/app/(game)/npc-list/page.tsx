...
export default function NpcListPage() {
    ...
    const handleSortChange = (key: SortKey) => {
        if (sortKey === key) {
            ...
            setSortDir(key === 'name' || key === 'nation' || key === 'city' ? 'asc' : 'desc');
        }
    };
    ...
    return (
        <div className="p-4 space-y-4 max-w-5xl mx-auto">
            ...
            <div className="flex gap-2 flex-wrap items-center">
                ...
                <span className="text-xs text-muted-foreground">{npcGenerals.length}명</span>
            </div>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {npcGenerals.map((g) => {
                                ...
                                const specialDisplay = g.specialCode && g.specialCode !== 'None' ? g.specialCode : '-';
                                const special2Display =
                                    g.special2Code && g.special2Code !== 'None' ? g.special2Code : '';
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className="text-sm">
                                            <span
                                                style={
                                                    g.npcState >= 5 ? { color: '#69f', fontWeight: 'bold' } : undefined
                                                }
                                            >
                                                {g.ownerName || '-'}
                                            </span>
