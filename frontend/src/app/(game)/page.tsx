                ...
                <>
                    ...
                    <div className="hidden lg:grid grid-cols-4 md:grid-cols-12 text-center text-[11px] border-t border-b border-gray-600 bg-[#111]">
                        ...
                        <div className="col-span-4 md:col-span-8 lg:col-span-4 border-b border-gray-600 py-1">
                            등록 제독: 유저 {genCounts.user.toLocaleString()} /{' '}
                            ...
                            .map((n) => (
                                ...
                                >
                                    <div className="min-w-0 flex-1">
                                        ...
                                        <p className="text-[10px] text-muted-foreground">제독 {n.genCount}명</p>
                                    </div>
                                </div>
                            ))}
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="text-xs space-y-1">
                            ...
                            <p>
                                <span className="text-muted-foreground">확장 제독:</span>{' '}
                            ...
                            <p>
                                <span className="text-muted-foreground">제독 제한:</span>{' '}
