    ...
    if (!emperorNation) {
        return (
            <div className="p-4 space-y-6 max-w-3xl mx-auto">
                ...
                <Card>
                    <CardContent>
                        <p className="text-sm text-muted-foreground">아직 황제를 칭한 진영이 없습니다.</p>
                    </CardContent>
                </Card>
            </div>
        );
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-3 text-sm">
                        <Row label="진영 레벨" value={String(emperorNation.level)} />
                        ...
                        <Row label="제독 수" value={`${nationGenerals.length}명`} />
                    </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-muted-foreground">
                                        통{chiefGeneral.leadership} 무{chiefGeneral.strength} 지{chiefGeneral.intel} 정
                                        {chiefGeneral.politics} 매{chiefGeneral.charm}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <CardContent>
                    <div className="space-y-2">
                        ...
                        {nationGenerals.filter((g) => g.officerLevel >= 5).length === 0 && (
                            <p className="text-sm text-muted-foreground">주요 관직 제독가 없습니다.</p>
                        )}
                    </div>
                </CardContent>
            </Card>
