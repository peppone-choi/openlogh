            ...
            {emperorNation ? (
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            <FactionBadge name={emperorNation.name} color={emperorNation.color} />
                            <Badge variant="secondary">황제국</Badge>
                            <Button asChild size="sm" variant="outline" className="ml-auto">
                                <Link href="/sovereign/detail">자세히</Link>
                            </Button>
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                            <StatItem label="진영 레벨" value={String(emperorNation.level)} />
                            ...
                            <StatItem label="제독" value={`${nationGenerals.length}명`} />
                        </div>
                            ...
                            <div className="border-t border-muted/30 pt-3">
                                ...
                                <div>
                                    <h4 className="text-xs text-muted-foreground mb-1">
                                        일반 제독 ({nationGenerals.filter((g) => g.officerLevel <= 1).length}
                                        명)
                                    </h4>
                ...
                <Card>
                    <CardContent className="py-4">
                        <p className="text-sm text-muted-foreground text-center">아직 황제를 칭한 진영이 없습니다.</p>
                    </CardContent>
                </Card>
            )}
                            ...
                            <TableBody>
                                {[...nations]
                                    ...
                                    .map((n) => (
                                        <TableRow key={n.id}>
                                            <TableCell>
                                                <FactionBadge name={n.name} color={n.color} />
                                            </TableCell>
                                            <TableCell>
                ...
                <CardContent className="space-y-3">
                    ...
                    {yearbook && (
                        <div className="space-y-2">
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        {yearbook.nations.map((yn) => (
                                            <TableRow key={yn.id}>
                                                <TableCell>
                                                    <FactionBadge name={yn.name} color={yn.color} />
                                                </TableCell>
                            ...
                            <div className="space-y-2">
                                <h5 className="text-xs font-semibold text-amber-400">제독 동향</h5>
