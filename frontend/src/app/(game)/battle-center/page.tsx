        ...
        <Card>
            ...
            <CardContent className="space-y-3 text-xs">
                ...
                <div className="grid grid-cols-3 gap-x-4 gap-y-1">
                    ...
                    <div>
                        <span className="text-muted-foreground">수비훈:</span> {general.defenceTrain}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-x-4 gap-y-1">
                    <div>
                        <span className="text-muted-foreground">전투:</span> {general.warnum ?? 0}
                    </div>
                    <div>
                    ...
                    <div>
                        <span className="text-green-400">살상:</span> {(general.killcrew ?? 0).toLocaleString()}
                    </div>
                    <div>
                        <span className="text-red-400">피해:</span> {(general.deathcrew ?? 0).toLocaleString()}
                    </div>
                    <div>
                        <span className="text-muted-foreground">화공:</span> {general.firenum ?? 0}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-1 border-t border-muted/30 pt-2">
                    ...
                    {general.belong !== undefined && (
                        <div>
                            <span className="text-muted-foreground">소속:</span> <span>{general.belong}턴</span>
                        </div>
                    )}
                </div>
            </CardContent>
        ...
        <Card>
            ...
            <CardContent className="text-xs space-y-1">
                <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                    ...
                    <div>
                        <span className="text-muted-foreground">공헌:</span> {general.dedication.toLocaleString()} (Lv.
                        {general.dedLevel})
                    </div>
                    <div>
                        <span className="text-muted-foreground">금:</span> {general.gold.toLocaleString()}
                    </div>
                    <div>
                        <span className="text-muted-foreground">쌀:</span> {general.rice.toLocaleString()}
                    </div>
                    <div>
                        <span className="text-muted-foreground">소속:</span> {general.belong}턴
                    </div>
                    <div>
                        <span className="text-muted-foreground">배반:</span> {general.betray}턴
                    </div>
                    <div>
            ...
            <CardContent>
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div className="mt-1 text-[10px] text-muted-foreground text-right">총 {logs.length}건</div>
                    </>
                )}
            </CardContent>
        </Card>
...
function StatRow({
    ...
    return (
        <div className="flex items-center gap-1">
            ...
            {exp !== undefined && exp > 0 && <span className="text-muted-foreground text-[10px]">(+{exp})</span>}
        </div>
    );
}
