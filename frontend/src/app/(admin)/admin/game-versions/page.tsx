        ...
        <div className="space-y-4">
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="space-y-1">
                            <span className="text-sm text-muted-foreground">Commit SHA (선택)</span>
                            <Input
                                placeholder="abc1234"
                                value={commitSha}
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    <Button variant="ghost" size="sm" onClick={fetchInstances} className="text-muted-foreground">
                        <RefreshCw className="size-4" />
                    </Button>
                </CardHeader>
                <CardContent>
                    {instances.length === 0 ? (
                        <p className="text-sm text-muted-foreground">실행 중인 인스턴스가 없습니다.</p>
                    ) : (
                                ...
                                >
                                    <div className="space-y-1">
                                        <div className="flex items-center gap-2">
                                            <span className="font-mono font-bold">{inst.gameVersion}</span>
                                            <Badge
                                        ...
                                        <div className="text-xs text-muted-foreground space-x-4">
                                            ...
                                            <span>
                                                Worlds: {inst.worldIds.length > 0 ? inst.worldIds.join(', ') : '없음'}
                                            </span>
                                        </div>
                                    </div>
                                    <Button
