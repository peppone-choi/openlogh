...
function getPlayerInfo(w: WorldState): {
    ...
    return {
        ...
        max: (config.generalCntLimit as number) ?? (meta.generalCntLimit as number) ?? 100,
        ...
        <div className="space-y-6">
            ...
            {notice && (
                <div className="text-center">
                    <span className="text-2xl font-bold text-orange-500" dangerouslySetInnerHTML={{ __html: notice }} />
                </div>
            )}
                                        ...
                                        <CardContent className="py-3 space-y-2">
                                            ...
                                            <div className="flex flex-wrap items-center gap-x-3 gap-y-0.5 text-[11px] text-muted-foreground">
                                                ...
                                                {w.meta?.openTime ? (
                                                    <span>
                                                        오픈:{' '}
                                                        {new Date(String(w.meta.openTime)).toLocaleDateString('ko-KR')}
                                                    </span>
                                                ) : null}
                                            </div>
                                            {/* Per-server notice */}
                                ...
                                <Card className="border-muted">
                                    <CardContent className="py-3">
                                        <div className="flex items-center justify-between text-xs">
                                            ...
                                            <Badge variant="outline" className={getServerPhase(currentWorld).color}>
