 ...
 */
export function GeneralSupplementCard({ general, showCommandList = false }: GeneralSupplementCardProps) {
    ...
    return (
        <div className="text-center text-sm border border-foreground/15 rounded-none overflow-hidden bg-card">
            {/* Stats section */}
