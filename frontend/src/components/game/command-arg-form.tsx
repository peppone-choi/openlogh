...
const COMMAND_HELP: Record<string, string> = {
    ...
    초토화: '선택된 도시를 초토화 시킵니다. 도시가 공백지가 되며, 국고가 확보됩니다. 수뇌들은 명성을 잃고, 모든 제독들은 배신 수치가 1 증가합니다.',
    // General-targeting commands
    등용: '다른 세력 제독를 등용합니다.',
    제독대상임관: '특정 제독의 세력에 임관합니다.',
    증여: '자신의 자금이나 군량을 다른 제독에게 증여합니다.',
    포상: '국고로 제독에게 자금이나 군량을 지급합니다.',
    몰수: '제독의 자금이나 군량을 몰수합니다. 몰수한것은 국가재산으로 귀속됩니다.',
    부대탈퇴지시: '지정한 제독에게 부대 탈퇴를 지시합니다. 부대원만 가능합니다.',
    발령: '제독를 지정한 도시로 발령합니다.',
    ...
    CR건국: '새 진영을 건국합니다. (특수)',
    무작위건국: '무작위 위치에 건국합니다.',
    선전포고: '타국에게 선전 포고합니다. 고립되지 않은 아국 도시에서 인접한 진영에 선포 가능합니다.',
