...
const SUPPLIED_POLE_CLIP = 'polygon(4px 0, 12px 0, 12px 12px, 3px 12px, 3px 5px, 4px 5px)';
const DEPLETED_POLE_CLIP = 'polygon(3px 0, 16px 0, 16px 16px, 3px 16px, 3px 14px, 5px 4px, 3px 4px, 3px 0)';
...
export function FactionFlag({ color, supplied, className, style }: FactionFlagProps) {
