...
function Progress({ className, font, variant, value, progressBg, indicatorColor, ...props }: BitProgressProps) {
            ...
            >
                <ProgressPrimitive.Indicator
                    ...
                    className={cn(
                        ...
                        variant !== 'retro' && (indicatorColor || progressBg || 'bg-primary')
                    )}
                                ...
                                return (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            i < filledSquares
                                                ? indicatorColor || progressBg || 'bg-primary'
                                                : 'bg-transparent'
                                        )}
                                    />
                                );
